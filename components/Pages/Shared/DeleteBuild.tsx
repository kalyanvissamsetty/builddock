...
export default function DeleteBuild() {
    ...
    async function onSubmit(e: React.FormEvent) {
        ...
        try {
            ...
            const data = await apiFetch<{ message: string, itemsDeleted: number }>(
                `/api/builds/deleteBuild`,
                { method: "POST",
            ...
            console.log("Total objects deleted - " + data?.itemsDeleted)
    ...
    return (
        <section className="mx-auto w-full max-w-4xl rounded-lg border p-10 bg-">
            ...
            >
                ...
                {isUpdateSuccess && (
                    <p className="text-sm text-green-600">Build Delete Successful</p>
                )}
